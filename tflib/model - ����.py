...
class BaseModel(object):
  ...
  def __init__(self, inputs, checkpoint_dir, session, is_training=False,
               reuse=False):
...
#    self.global_step = tf.Variable(0, name='global_step', trainable=False) #TODO
...
#            print('target=', step_data['target'][0:5])
#            print('pred = ', step_data['pred'][0:5])
